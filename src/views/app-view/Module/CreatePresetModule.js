...
const CreatePresetModule = () => {
  ...
  const createPresetModule = (data) => {
    axios.post("/api/module/create-preset-module", data).then((response) => {
      message.destroy()
...
return (
    ...
    <Row>
      <Col md="12">
        <Card title="Create Preset Module" extra={<>
