...
, []);
  ...
  const updatePresetModule = (data) => {
    axios.post("/api/module/update-preset-module", data).then((response) => {
      message.destroy()
...
return (
    ...
    <Row>
      <Col md="12">
        <Card title="Edit Preset Module" loading={isLoading} extra={<>
...
export default EditPresetModule;