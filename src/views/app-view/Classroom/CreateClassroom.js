...
const CreateClassroom = () => {
  ...
  useEffect(() => {
    axios.get("/teacher/get-teacher-fullname/" + teacherId).then((response) => {
  ...
  const createClassroom = (data) => {
    axios.post("/teacher/create-classroom", data).then((response) => {
      console.log(response.data)
      axios.get("/teacher/get-classroom-code/" + response.data).then((response) => {
        message.destroy()
